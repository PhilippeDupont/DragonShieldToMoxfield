...
const translations = {
  fr: {
    ...
    downloadDiffMox: 'Télécharger ajouts Moxfield',
    downloadDiffDS: 'Télécharger ajouts DragonShield',
  ...
  en: {
    ...
    downloadDiffMox: 'Download Moxfield additions',
    downloadDiffDS: 'Download DragonShield additions',
